...
public class Course extends BaseEntity {
    ...
    public void setHours(int hours) throws InvalidValueException {
        if (hours > 0 && hours < 10) {
            ...
            throw new InvalidValueException("Stundenanzahl muss zwischen 1 und 10 sein!");
        }
    }
        ...
        if (beginDate != null) {
            if (this.endDate != null) {
                if (beginDate.before(this.endDate)) {
                    ...
                    throw new InvalidValueException("Start-Datum muss vor End-Datum sein!");
                }
            } else {
                this.beginDate = beginDate;
            }
        } else {
            throw new InvalidValueException("Start-Datum darf nicht leer sein!");
        }
    }
        ...
        if (endDate != null) {
            if (this.beginDate != null) {
                if (endDate.after(this.beginDate)) {
                    ...
                    throw new InvalidValueException("End-Datum muss nach Start-Datum sein!");
                }
            } else {
                this.endDate = endDate;
            }
        } else {
            throw new InvalidValueException("End-Datum darf nicht leer sein!");
        }
    }
